...
const Navbar = () => {
  ...
  return (
    <div className=' flex  justify-between  items-center h-24 max-w-[1240px] px-4 mx-auto text-white'>
        ...
        <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-500 bg-gray-800 ease-in-out duration-1000' : 'fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'>REACT.</h1>
            <ul className='p-4 uppercase'>
            <li className='p-4 border-b border-black'>Home</li>
            <li className='p-4 border-b border-black'>Company</li>
            <li className='p-4 border-b border-black'>Resources</li>
